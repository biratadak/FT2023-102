...
<div class="posts-body">
  <!-- Left section shows the user profile pic, name, about and online/offline users -->
  <section class="left-section  fd-col">
    <!-- Left upper div shows the user profile pic, name and about -->
    ...
    <!-- Left lower section shows the online/offline users -->
  ...
  <!-- Left section shows the post creation section at top then followed by all posts -->
